		...
		<div class="flex items-center gap-1 lg:w-[400px] grow lg:grow-0">
			...
			<div class="flex items-center gap-2">
				<a class="flex items-center shrink-0" href="{{ url('/') }}" title="PDV Connect">
					<img class="dark:hidden w-8 shrink-0" src="{{ asset('assets/media/app/mini-logo-v2.svg') }}" alt="PDV Connect" />
					<img class="hidden dark:inline-block w-8 shrink-0" src="{{ asset('assets/media/app/mini-logo-v2-dark.svg') }}" alt="PDV Connect" />
				</a>
