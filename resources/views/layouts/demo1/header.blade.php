<!-- Header -->
<header class="kt-header fixed end-0 start-0 top-0 z-10 flex shrink-0 items-stretch bg-yellow-400" data-kt-sticky="true"
    data-kt-sticky-class="border-b border-yellow-500" data-kt-sticky-name="header" id="header">
    <!-- Container -->
